  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="" class="d-block"><b style="text-transform: capitalize; font-size:150%;"><?php print_r($this->session->userdata('user_name'));?></b></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.html" class="nav-link <?php if(isset($sub)&&$sub=="add_t")echo 'active'?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Add Trainer</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index2.html" class="nav-link <?php if(isset($sub)&&$sub=="view_t")echo 'active'?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Trainers</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index3.html" class="nav-link <?php if(isset($sub)&&$sub=="rm_t")echo 'active'?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Remove Trainer</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link <?php if(isset($sec)&&$sec=="student")echo 'active'?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/layout/fixed-footer.html" class="nav-link <?php if(isset($sub)&&$sub=="fees")echo 'active'?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fees</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/layout/fixed-sidebar.html" class="nav-link <?php if(isset($sub)&&$sub=="dnr_s")echo 'active'?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Disenroll</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/layout/fixed-sidebar-custom.html" class="nav-link <?php if(isset($sub)&&$sub=="ter_s")echo 'active'?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Terminate </p>
                </a>
              </li>
