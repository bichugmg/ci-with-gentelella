...
<html lang="en">
  <head>
    ...
    <title>Trainer Registration | Team INTERVAL™</title>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="user_check" method="post" autocomplete="off" onsubmit="return validate(this)">
              <h1>Trainer's Portal</h1>
              <div>
                <input type="email" class="form-control" name="email_id" placeholder="Email ID" required="required" />
              </div>
              <div>
                <input type="number" class="form-control" name="mob_no" id="mob_no" minlength="10" maxlength="10" placeholder="Mobile Number" required="required" />
              </div><br>
              <div>
                <button type="submit" name="submit" class="btn btn-dark">Sign Up / Login <i class='fa fa-sign-in' style="font-size: 20px;vertical-align: middle;"></i></button>
                <br><br>
