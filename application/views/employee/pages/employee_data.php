          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Employee Data<small>INTERVAL</small></h2>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        foreach ($trainer_data ->result() as $value) {
                          ...
                          <td align="center" height="5px"><?php echo $value->city_town.'<br>'.$value->district ;?></td>                     
                          <td align="center" height="5px" style="max-width: 100%; white-space: nowrap;"><?php echo $value->jod ;?></td>                     
                          <td align="center" height="5px" style="max-width: 100%; white-space: nowrap;"><?php echo $value->course_name." (".$value->course_stream_name.")" ;?></td>                   
                          <td align="center" height="5px" style="max-width: 100%; white-space: nowrap;"><?php echo $value->modify_date ;?></td>                       
                          </tr>
                        <?php
                      }
                        ?>
