          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Salary Account<small>* Indicates Mandatory Fields</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      <form id="demo-form2"  data-parsley-validate class="form-horizontal form-label-left" method="post" action="bank_data" enctype="multipart/form-data" autocomplete="off">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="account_holder" name="account_holder" required="required" class="form-control " value="<?php echo $profile['data']->account_holder; ?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="ifsc" name="ifsc" required="required" class="form-control " maxlength="11" minlength="11" value="<?php echo $profile['data']->ifsc; ?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="number" id="account_no" name="account_no" required="required" class="form-control " value="<?php echo $profile['data']->account_no; ?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="number" id="c_account_no" name="c_account_no" required="required" class="form-control " value="<?php echo $profile['data']->account_no; ?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <select name="upi_app" id="upi_app" class="form-control" required>
                                ...
                                <option value="Amazon Pay" <?php if($profile['data']->upi_app=="Amazon Pay") echo "selected='selected'"; ?> >Amazon Pay</option>
                                <option value="Google Pay" <?php if($profile['data']->upi_app=="Google Pay") echo "selected='selected'"; ?> >Google Pay</option>
                                <option value="PayTM" <?php if($profile['data']->upi_app=="PayTM") echo "selected='selected'"; ?> >PayTM</option>
                                <option value="PhonePe" <?php if($profile['data']->upi_app=="PhonePe") echo "selected='selected'"; ?> >PhonePe</option>
                                <option value="Whatsapp Payment" <?php if($profile['data']->upi_app=="Whatsapp Payment") echo "selected='selected'"; ?> >Whatsapp Payment</option>
                            </select>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="number" id="upi_mob_no" name="upi_mob_no" required="required" class="form-control " placeholder="Enter UPI Registered Mobile No." value="<?php echo $profile['data']->upi_mob_no; ?>">
                            </div>
                          </div>
...
$('#account_holder').on('focus', function() {
                            if($('#account_holder').val().length==0)
                             $('#account_holder').val('<?php echo $this->session->userdata('name'); ?>');
                    });
...
$(document).ready(function(){
                        var ifsc="<?php echo $profile['data']->ifsc; ?>"
                        $.ajax({
                         url: "<?php echo base_url().'employee/get_ifsc_branch?id='; ?>"+ifsc,
                         type: 'get',
                         dataType: 'json',
...
$('#ifsc').on('focusout', function() {
                        $.ajax({
                         url: "<?php echo base_url().'employee/get_ifsc_branch?id='; ?>"+this.value,
                         type: 'get',
                         dataType: 'json',
                         success: function(response){
                             if(response.BANK!="")
