                  ...
                  <div class="x_content">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="account_holder" name="account_holder" required="required" class="form-control " value="<?php echo $profile['data']->account_holder; ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="ifsc" name="ifsc" required="required" class="form-control " maxlength="11" minlength="11" value="<?php echo $profile['data']->ifsc; ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="number" id="account_no" name="account_no" required="required" class="form-control " value="<?php echo $profile['data']->account_no; ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <input type="text" style="text-transform : none;" id="account_holder" name="account_holder" required="required" class="form-control " value="<?php echo $profile['data']->upi_app; ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="number" id="upi_mob_no" name="upi_mob_no" required="required" class="form-control " placeholder="Enter UPI Registered Mobile No." value="<?php echo $profile['data']->upi_mob_no; ?>" readonly>
                            </div>
                          </div>
